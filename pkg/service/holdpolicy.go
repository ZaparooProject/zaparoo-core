...
func holdModeForToken(svc *ServiceContext, t *tokens.Token) bool {
	return scanmode.HoldForToken(svc.Config, svc.State, t)
}
...
// still present. See scanmode.ForTokenAfterRemoval.
func holdModeForTokenAfterRemoval(svc *ServiceContext, t *tokens.Token) bool {
	return scanmode.HoldForTokenAfterRemoval(svc.Config, svc.State, t)
}
