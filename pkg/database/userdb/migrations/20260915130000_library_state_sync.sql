...
-- copy of yet. SentPreferredTags is the version this device last named from
-- its starred copy, so a star that moves is told apart from a version the
-- account chose.
...
(
    ...
    SentPreferredTags text    not null default '[]',
